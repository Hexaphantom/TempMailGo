...
T.en = {
  ...
  hero_sub: 'Generate a free temp mail address that receives real emails and OTP verification codes in seconds. No signup, no personal info, no spam in your real inbox.',
  ...
  f2t: 'Real-time inbox', f2d: 'Incoming mail appears automatically within seconds. Live polling keeps your inbox fresh without a refresh.',
  f3t: 'Receives real OTP codes', f3d: 'Get genuine verification codes and confirmation links. Detected codes are highlighted so you can copy them instantly.',
  f4t: '10+ domains', f4d: 'Choose from .com, .net, .org, .xyz, .online, .dev and more. Switch domains if a site blocks one.',
  f5t: 'Attachments & HTML', f5d: 'View full HTML and plain-text bodies, sender details, timestamps, and attachment info safely in a sandbox.',
